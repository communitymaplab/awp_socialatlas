...
atlasdata$description[atlasdata$var == "Rce_WhtNH.y16"] <- "White non-hispanic population" #needswork
...
output$map <- renderLeaflet({
  ...
  pal <- colorBin("Reds", mapdata$est, n = nclassint)
