...
```{r}
# There are tracts in the data that do no exist in the crosswalk,
# this is creating na values when joining
...
write.csv(census_data_atlas2,"data/GA_2020/ESzones_acs_interpolation.csv")
