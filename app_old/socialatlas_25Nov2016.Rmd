...
districts<-readOGR(".","ElementarySchoolDistricts_data") #Will need to be updated. Ideally you would join from the atlanta data wide
atlasdata<-melt(atlasdata_wide,id.vars=c("School","SchoolID"))
...
filteredData_variable<-reactive({
  dist<-subset(districts,select=c("ES_short",variable()))
